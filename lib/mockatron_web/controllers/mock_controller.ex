defmodule MockatronWeb.MockController do
  ...
  def response(%Plug.Conn{assigns: %{mockatron: %{agent: %{found: true, agent: %{content_type: content_type}},responder: %{found: true, pid: responder, module: module}}}} = conn, _params) do
